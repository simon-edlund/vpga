...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/rounds',          component: () => import('../views/RoundsView.vue'),         meta: { requiresAuth: true, requiresAdmin: true } },
    { path: '/rounds/:id',      component: () => import('../views/RoundDetailView.vue'),    meta: { requiresAuth: true, requiresAdmin: true } },
